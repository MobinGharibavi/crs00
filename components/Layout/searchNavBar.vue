              ...
              <TransitionExpand :duration="500">
                ...
                >
                  ...
                  >
                    ...
                    <span>{{ $t("search.navBar.profile.transactions") }}</span>
                  </div>
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="text-orange">{{ $t("search.navBar.profile.deposite") }}</span>
                  </div>
              ...
              <TransitionExpand :duration="500">
                ...
                >
                  <div class="sticky top-0 bg-white w-full text-center">
                    <span class="text-blue-500"> {{ $t("search.navBar.notification.showMore") }}</span>
                  </div>
                  <template v-for="(item, index) in 7" :key="index">
                    <main class="flex flex-col gap-1.5">
                      <div class="flex items-center gap-2">
                        <Icon name="map:airport" size="1.2rem" />
                        <span>{{ $t("search.navBar.notification.title") }}</span>
                      </div>
                      <p class="text-gray-400">
                        {{ $t("search.navBar.notification.body") }}
                      </p>
                      <span class="text-gray-400 text-xs"> Today - 12:10 </span>
                    </main>
                  </template>
                </div>
              </TransitionExpand>
